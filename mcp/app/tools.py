        ...
        return [
            Tool(name="create_node", description="Add a new node to the homelab canvas", inputSchema={
                ...
                "properties": {
                    ...
                    "check_method":   {"type": "string", "enum": ["ping","http","https","tcp","ssh"], "description": "How to check if this node is online"},
                    "check_target":   {"type": "string", "description": "URL or host:port for the check (e.g. https://192.168.1.137:8006)"},
                    "container_mode": {"type": "boolean", "description": "If true, child nodes render nested inside this node"},
                    "os":             {"type": "string"},
                    "notes":          {"type": "string"},
                },
            }),
            Tool(name="update_node", description="Update an existing node", inputSchema={
                ...
                "properties": {
                    ...
                    "os":             {"type": "string"},
                    "notes":          {"type": "string"},
                    "services":       {"type": "array", "items": {"type": "object"}, "description": "List of services [{port, protocol, service_name, category}]"},
                    "type":           {"type": "string", "enum": ["isp","router","switch","server","proxmox","vm","lxc","nas","iot","ap","generic"]},
